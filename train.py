...
class Train:
    def __init__(self, root):
        ...
        img_top = Image.open(
            r"C:\Users\rejoy\Desktop\face_recognition_system\pictures\desk.jpg")
        ...
        b1_1 = Button(self.root, text="TRAIN DATA", command=self.train_classifier,
                      cursor="hand2", font=("times new roman", 15, "bold"), bg="red", fg="white")
        b1_1.place(x=0, y=380, width=1530, height=40)

        img_bottom = Image.open(r"C:\Users\rejoy\Desktop\face_recognition_system\pictures\desk.jpg"
                                )
    ...
    def train_classifier(self):
        ...
        if not path:
            messagebox.showerror(
                "Error", "No data found for training. Please add some data first.")
            return
        ...
        # Load previously trained data, if exists
        ...
        # Train the classifier with both existing and new data
        clf.train(faces, ids)
