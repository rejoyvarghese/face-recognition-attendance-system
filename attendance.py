...
class Attendance:
    def __init__(self, root):
        ...
        # first image
        img = Image.open(
            r"C:\Users\rejoy\Desktop\face_recognition_system\pictures\att1.jpg")
        ...
        # second image
        img1 = Image.open(
            r"C:\Users\rejoy\Desktop\face_recognition_system\pictures\att2.jpg")
        ...
        title_lbl = Label(text="ATTENDANCE MANAGEMENT SYSTEM", font=(
            "comicsansns 11 bold"), bg="white", fg="darkgreen")
        title_lbl.place(x=150, y=0, width=1400, height=45)

        main_frame = Frame(bd=2, bg="white")
        main_frame.place(x=10, y=200, width=1480, height=600)
        ...
        img_left = Image.open(
            r"C:\Users\rejoy\Desktop\face_recognition_system\pictures\att3.jpg")
        ...
        # attendance
        namelabel = Label(left_inside_frame, text="Attendance Status: ", font=(
            "comicsansns 11 bold"), bg="white")
        ...
        Right_frame = LabelFrame(main_frame, bd=2, relief=RIDGE, text="Attendance Details", font=(
            "comicsansns 11 bold"))
        Right_frame.place(x=780, y=10, width=729, height=580)
    ...
    def exportCsv(self):
        try:
            ...
            with open(fin, mode="w", newline="") as myfile:
                ...
                messagebox.showinfo(
                    "Data Export", "You're data exported to "+os.path.basename(fin)+" successfully")
