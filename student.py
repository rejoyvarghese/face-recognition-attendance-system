...
# ================variables-------------------
        ...
        self.var_teaher = StringVar()

        # first image
        img = Image.open(
            r"C:\Users\rejoy\Desktop\face_recognition_system\pictures\student first img.jpg")
        ...
        # second image
        img1 = Image.open(
            r"C:\Users\rejoy\Desktop\face_recognition_system\pictures\student second image.jpg")
        ...
        # third image
        img2 = Image.open(
            r"C:\Users\rejoy\Desktop\face_recognition_system\pictures\student third image.jpg")
        ...
        img_left = Image.open(
            r"C:\Users\rejoy\Desktop\face_recognition_system\pictures\left label.jpg")
       ...
       # current course
        ...
        course_combo["values"] = ("Select Course", "FY", "SY", "TY", "Final")
        ...
        year_label_combo = ttk.Combobox(current_course_frame, textvariable=self.var_year, font=(
            "times new roman", 13, "bold"), state="readonly")
        year_label_combo["values"] = (
        ...
        teacher_entry = ttk.Entry(class_Student_frame, textvariable=self.var_teaher, width=20, font=(
            "times new roman", 13, "bold"))
        ...
        img_right = Image.open(
            r"C:\Users\rejoy\Desktop\face_recognition_system\pictures\student.jpg")
...
# -----------------SEARCH SYSTEM ----------------
        ...
        seacrh_btn = Button(Search_frame, text="Search", width=12, font=(
            "times new roman", 10, "bold"), bg="blue", fg="white")
        seacrh_btn.grid(row=0, column=3)
        ...
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                conn = mysql.connector.connect(
                    host="localhost", username="root", password="rejoymysql@15", database="face_recognizer")
            ...
            try:
                ...
                if delete > 0:
                    ...
                    if not delete:
                        return
                messagebox.showinfo(
                    "Delete", "Student details successfully deleted", parent=self.root)
                conn.commit()
                self.fetch_data()
                conn.close()
            except Exception as es:
    ...
    def generate_dataset(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                ...
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        cv2.putText(face, str(img_id), (50, 50),
                                    cv2.FONT_HERSHEY_COMPLEX, 2, (0, 255, 100), 2)
                ...
                messagebox.showinfo("Result", "genreting Dataset completed")
