...
class Face_Recognition:
    def __init__(self, root):
        ...
        # first img
        img_left = Image.open(
            r"C:\Users\rejoy\Desktop\face_recognition_system\pictures\face_rec1.png")
        img_left = img_left.resize((710, 721))
        ...
        # second img
        img_top = Image.open(
            r"C:\Users\rejoy\Desktop\face_recognition_system\pictures\face_rec2.png")
    ...
    def face_recog(self):
        def draw_boundray(img, classifier, scaleFactor, minNeighbors, color, text, clf):
            ...
            for (x, y, w, h) in features:
                ...
                if confidence > 60:
                    cv2.putText(
                        img, f"ID:{i}", (x, y-55), cv2.FONT_HERSHEY_COMPLEX, 0.8, (255, 255, 255), 3)
                    cv2.putText(
                    ...
                    cv2.putText(img, f"Department:{
                                d}", (x, y-5), cv2.FONT_HERSHEY_COMPLEX, 0.8, (255, 255, 255), 3)
        ...
        def recognize(img, clf, faceCascade):
            coord = draw_boundray(img, faceCascade, 1.1, 10, (255, 25, 255),
                                  "Face", clf)
            return img
